/**
 * Normalize Outline V11 - Converts string turning_points to structured objects
 * 
 ...
 * 
 * This normalizer runs BEFORE QC and BEFORE saving to ensure consistency.
 */
 ...
 * Run this BEFORE QC and BEFORE saving to database
 */
export function normalizeOutlineV11<T extends Record<string, unknown>>(outline: T): T {
